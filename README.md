...
The get the framework up and running, you need this repository as well as item (a) from above; see also [Folder Setup](#folder-setup) for more related details.
