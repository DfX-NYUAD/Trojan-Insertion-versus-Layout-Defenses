...
#TODO check whether deleting and then uploading again but w/ same name is considered as new file/download again? Should be, assuming there are unique hashes per upload generated by Gdrive backend
google_downloads() {
