...
#
## NOTE deprecated; further differentiate for different modes
#ecoPlace -fixPlacedInsts true -timing_driven true

# NOTE trial runs on the misty baseline, using Trojan misty_leak_16_5_targeted, across all design dbs (thus exploring 3x3=9 options), had shown the following:
...
#
# NOTE for these exploration runs, Trojans had not been shrunk yet, and actual commands differed also (still kept in comments below)
...
#		ecoPlace -fixPlacedInsts false -timing_driven true
	...
	"adv2" {
		...
		# NOTE also allow more changes on other instances
		ecoPlace -fixPlacedInsts false -timing_driven true
#
#		# NOTE deprecated; first version
#		# NOTE given the 'place_detail_eco_priority_insts eco' setting, this should not be too aggressive
