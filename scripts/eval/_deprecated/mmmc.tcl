...
#NOTE results will differ versus explicit early, late definition
#create_delay_corner -name TT_delay_corner -timing_condition {TT_timing_cond} -rc_corner {TT_rc_corner}
